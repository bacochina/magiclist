...
export const SPECIFIC_FIELDS_PROMPT = `
Você é um especialista em modelagem de banco de dados. Com base no prompt fornecido, gere campos específicos para uma tabela SQL.
...
Por favor, gere campos SQL específicos seguindo estas diretrizes:
1. Use tipos de dados PostgreSQL apropriados
2. Inclua descrições claras para cada campo
3. Indique quais campos são obrigatórios
4. Sugira chaves primárias e estrangeiras quando apropriado
