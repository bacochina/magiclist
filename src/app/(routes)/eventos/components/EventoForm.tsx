...
export function EventoForm({ 
  ...
  const [hospedagem, setHospedagem] = useState<Hospedagem>({
    ...
    horarioCafeInicio: evento?.hospedagem?.horarioCafeInicio || '08:00',
    horarioCafeFim: evento?.hospedagem?.horarioCafeFim || '10:00',
    ...
    quartos: evento?.hospedagem?.quartos || [],
  });
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6 text-white max-w-5xl mx-auto p-6 bg-gray-900/50 backdrop-blur-sm rounded-2xl border border-white/10 shadow-xl">
      ...
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="space-y-2">
          ...
          <div className="mt-2 flex justify-end">
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 border border-indigo-500 text-xs font-medium rounded-xl
                       ...
                       shadow-sm transition-all duration-200 ease-in-out h-8 disabled:opacity-50 disabled:cursor-not-allowed"
            >
          ...
          {mostrarModalRotas && (
            <div className="mt-4 bg-gray-800/50 rounded-xl border border-white/10 p-4 animate-fadeIn">
            ...
            <div className="space-y-6">
              ...
              <div className="mt-8 p-6 bg-gray-900 rounded-2xl border border-white/20">
                <div className="flex items-center justify-between mb-6">
                  <h5 className="text-sm font-semibold text-white">Informações de Hospedagem</h5>
                  <div className="flex items-center">
                    <input
                      type="checkbox"
                      id="incluiCafe"
                      ...
                      className="h-4 w-4 text-indigo-500 focus:ring-indigo-500 border-white rounded"
                    />
                    <label htmlFor="incluiCafe" className="ml-3 text-sm font-semibold text-white">
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-white">Data de Check-in</label>
                      <input
                        type="date"
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-white">Data de Check-out</label>
                      <input
                        type="date"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-white">Hora de Check-in</label>
                      <input
                        type="time"
                    ...
                    <div className="space-y-2">
                      <label className="block text-sm font-medium text-white">Hora de Check-out</label>
                      <input
                        type="time"
                  ...
                  {/* Horários de café da manhã - exibidos apenas se incluiCafe for true */}
                  {hospedagem.incluiCafe && (
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-indigo-900/30 rounded-xl border border-indigo-500/30">
                      <div className="space-y-2">
                        <label className="block text-sm font-medium text-white">Horário de Início do Café</label>
                        <input
                          type="time"
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-medium text-white">Horário de Término do Café</label>
                        <input
                          type="time"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="p-4 bg-gray-800/60 rounded-xl space-y-4">
                      <div className="space-y-2">
                        <label className="block text-sm font-medium text-white">Quantidade de Quartos</label>
                        <input
                          type="number"
                      ...
                      <div className="space-y-2">
                        <label className="block text-sm font-medium text-white">Distribuição dos Quartos</label>
                        <input
                          type="text"
                          value={hospedagem.distribuicaoQuartos}
                          onChange={(e) => setHospedagem({ ...hospedagem, distribuicaoQuartos: e.target.value })}
                          placeholder="Ex: 2 quartos duplos, 1 quarto triplo"
                          className="block w-full rounded-xl bg-gray-800/50 border border-white/20 text-sm text-white placeholder-gray-400
                                   focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:ring-opacity-50 shadow-sm
                                   transition-all duration-200 ease-in-out px-3 py-2 h-9"
                        />
                  ...
                  {/* Informações de WiFi */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-4 bg-gray-800/60 rounded-xl">
                    <div className="space-y-2">
