...
interface BlocosRepertorioProps {
  blocos: Bloco[];
...
export function BlocosRepertorio({ blocos, onRemoverBloco, onReordenarBlocos, onDuplicarBloco, onAtualizarBlocos }: BlocosRepertorioProps) {
