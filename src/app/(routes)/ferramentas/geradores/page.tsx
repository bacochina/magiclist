    ...
    <div className="container mx-auto py-8 px-4 max-w-7xl">
      <div className="mb-6">
        ...
        <p className="text-gray-400 max-w-3xl">
          Ferramentas para geração automática de documentos, listas e outros conteúdos úteis para bandas.
        </p>
      </div>
      ...
      <div className="bg-gray-900/60 border border-white/10 rounded-xl p-8 text-center">
        ...
        <p className="text-gray-400 max-w-lg mx-auto mb-6">
          Estamos trabalhando para implementar geradores úteis para ajudar no gerenciamento de suas bandas e eventos. Esta funcionalidade estará disponível em breve.
        </p>
        <div className="inline-block relative">
          <div className="h-2 w-48 bg-gray-800 rounded-full overflow-hidden">
            <div className="h-full bg-gradient-to-r from-yellow-400 to-amber-500 w-1/3 rounded-full animate-pulse-slow"></div>
          </div>
        </div>
      </div>
    </div>
