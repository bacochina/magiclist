...
import { Music2, Disc, ListMusic } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { TableIcon, Grid } from 'lucide-react';

// Criando uma página de formulário simples para nova música
export default function NovaMusicaPreview() {
  return (
    <div className="container mx-auto p-6">
      <div className="space-y-1 mb-8">
        <h1 className="text-4xl font-bold text-white">Nova Música</h1>
      ...
      <div className="flex flex-wrap gap-4 mb-8">
        <div className="stat-card group relative overflow-hidden p-3 bg-gradient-to-r from-gray-800 to-gray-800/95 rounded-xl border border-gray-700/50 shadow-md transition-all duration-300 hover:shadow-purple-900/20 hover:border-purple-500/30 flex flex-1 items-center justify-between min-w-[200px]">
          ...
          <div className="text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent group-hover:from-purple-200 group-hover:to-purple-400 transition-colors duration-300">48</div>
        </div>
        ...
        <div className="stat-card group relative overflow-hidden p-3 bg-gradient-to-r from-gray-800 to-gray-800/95 rounded-xl border border-gray-700/50 shadow-md transition-all duration-300 hover:shadow-indigo-900/20 hover:border-indigo-500/30 flex flex-1 items-center justify-between min-w-[200px]">
          ...
          <div className="text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent group-hover:from-indigo-200 group-hover:to-indigo-400 transition-colors duration-300">15</div>
        </div>
      ...
      <div className="bg-slate-800 rounded-lg p-6 space-y-4">
        <div className="space-y-2">
          <label className="text-sm font-medium text-white">Título da Música</label>
          <input 
            type="text" 
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-white">Artista/Banda</label>
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-white">Tonalidade</label>
          <select className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-md">
        ...
        <div className="space-y-2">
          <label className="text-sm font-medium text-white">Letra/Acordes</label>
          <textarea 
            className="w-full px-3 py-2 bg-slate-700 border border-slate-600 rounded-md min-h-[200px]"
            placeholder="Cole a letra e acordes da música aqui"
          ></textarea>
        </div>
